...
---@field devices table<string, device>                  (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [devices](device.lua) in the emulated system.
---@field palettes table<string, device_palette>         (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [palette devices](device_palette.lua) in the emulated system.
---@field screens table<string, screen_device>           (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [screen devices](screen_device.lua) in the emulated system.
---@field cassettes table<string, cassette_image_device> (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [cassette image devices](cassette_image_device.lua) in the emulated system.
---@field images table<string, device_image>             (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [media image devices](device_image.lua) in the emulated system.
---@field slots table<string, device_slot>               (read-only) A [device enumerator](https://docs.mamedev.org/techspecs/luareference.html#luareference-dev-enum) that yields all [slot devices](device_slot.lua) in the emulated system.
